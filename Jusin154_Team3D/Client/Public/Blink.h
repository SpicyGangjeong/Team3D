...
private:
	...
	class CEffectParts* m_pBlink_Swirl = { nullptr };
	class CEffectParts* m_pBlink_Circle = { nullptr };
	class CEffectParts* m_pBlink_Circle2 = { nullptr };
	class CEffectParts* m_pBlink_Distortion = { nullptr };
