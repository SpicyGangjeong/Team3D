...
class CCallBack_NonPlayable_Behavior final : public PSX::PxControllerBehaviorCallback
{
	// 구현 예시 
...
private:
	CCallBack_NonPlayable_Behavior();
public:
	~CCallBack_NonPlayable_Behavior();
...
public:
	static CCallBack_NonPlayable_Behavior* Create();
};
NS_END
