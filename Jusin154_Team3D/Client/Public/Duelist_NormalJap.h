...
class CDuelist_NormalJap final : public CEffect_Container
{
private:
	CDuelist_NormalJap(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDuelist_NormalJap(const CDuelist_NormalJap& rhs);
	virtual ~CDuelist_NormalJap() = default;
...
public:
	static CDuelist_NormalJap* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
