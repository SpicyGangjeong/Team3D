...
class CState_Parry final : public CState_Root
{
public:
    typedef struct tagParry : public CState_Root::STATE_ROOT_DESC {
...
private:
    HRESULT Initialize(STATE_PARRY_DESC* pDesc);

public:
    static CState_Parry* Create(STATE_PARRY_DESC* pDesc);
