...
class CDuelist_JapSide final : public CEffect_Container
{
private:
	CDuelist_JapSide(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDuelist_JapSide(const CDuelist_JapSide& rhs);
	virtual ~CDuelist_JapSide() = default;
...
public:
	static CDuelist_JapSide* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
