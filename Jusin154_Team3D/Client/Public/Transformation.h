...
class CTransformation final : public CEffect_Container
{
private:
	CTransformation(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTransformation(const CTransformation& rhs);
...
public:
	static CTransformation* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
