...
class CRanrok_PropHit final : public CEffect_Container
{
private:
	CRanrok_PropHit(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRanrok_PropHit(const CRanrok_PropHit& rhs);
	virtual ~CRanrok_PropHit() = default;
...
public:
	static CRanrok_PropHit* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
