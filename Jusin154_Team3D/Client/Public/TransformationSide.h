...
class CTransformationSide final : public CEffect_Container
{
private:
	CTransformationSide(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTransformationSide(const CTransformationSide& rhs);
	virtual ~CTransformationSide() = default;
...
public:
	static CTransformationSide* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
