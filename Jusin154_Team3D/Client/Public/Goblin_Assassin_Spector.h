...
class CGoblin_Assassin_Spector final : public CMonster
{
public:
...
private:
	CGoblin_Assassin_Spector(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CGoblin_Assassin_Spector(const CGoblin_Assassin_Spector& Prototype);
	virtual ~CGoblin_Assassin_Spector() = default;
...
private:
	class CGoblin_Assassin* m_pGoblin = { nullptr };
...
public:
	static CGoblin_Assassin_Spector* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
