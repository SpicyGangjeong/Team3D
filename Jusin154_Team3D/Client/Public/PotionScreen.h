...
class CPotionScreen final : public CEffect_Container
{
private:
	CPotionScreen(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPotionScreen(const CPotionScreen& rhs);
	virtual ~CPotionScreen() = default;
...
public:
	static CPotionScreen* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
