...
class CState_Fall final : public CState_Root
{
public:
    typedef struct tagFall : public CState_Root::STATE_ROOT_DESC {
...
private:
    HRESULT Initialize(STATE_FALL_DESC* pDesc);

public:
    static CState_Fall* Create(STATE_FALL_DESC* pDesc);
