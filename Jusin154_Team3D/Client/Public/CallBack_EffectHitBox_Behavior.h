...
class CCallBack_EffectHitBox_Behavior final : public PSX::PxControllerBehaviorCallback
{
	// 구현 예시 
...
private:
	CCallBack_EffectHitBox_Behavior();
public:
	~CCallBack_EffectHitBox_Behavior();
...
public:
	static CCallBack_EffectHitBox_Behavior* Create();
};
NS_END
