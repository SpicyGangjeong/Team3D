...
class CReparo final : public CEffect_Container
{
private:
	CReparo(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CReparo(const CReparo& rhs);
	virtual ~CReparo() = default;
...
public:
	static CReparo* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
