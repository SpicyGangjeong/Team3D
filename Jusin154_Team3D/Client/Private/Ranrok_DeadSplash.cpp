...
HRESULT CRanrok_DeadSplash::Pre_Setting(CGameObject* pObject, void* pArg)
{
	...
	CEffectParts* pDead_Decal = Get_PartObject<CEffectParts>("Dead_Decal");
	CEffectParts* pRock_PT = Get_PartObject<CEffectParts>("Rock_PT");
	CEffectParts* pRock_Splash = Get_PartObject<CEffectParts>("Rock_Splash");
	CEffectParts* pSplash = Get_PartObject<CEffectParts>("Splash");
