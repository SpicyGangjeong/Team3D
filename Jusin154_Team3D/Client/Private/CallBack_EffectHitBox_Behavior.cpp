...
CCallBack_EffectHitBox_Behavior::CCallBack_EffectHitBox_Behavior()
{
}
...
PSX::PxControllerBehaviorFlags CCallBack_EffectHitBox_Behavior::getBehaviorFlags(const PSX::PxShape& shape, const PSX::PxActor& actor)
{
...
PSX::PxControllerBehaviorFlags CCallBack_EffectHitBox_Behavior::getBehaviorFlags(const PSX::PxController& controller)
{
	// CCT끼리 부딪힐 때를 굳이 안 쓰면 0 리턴
	return PSX::PxControllerBehaviorFlag::eCCT_SLIDE;
}

PSX::PxControllerBehaviorFlags CCallBack_EffectHitBox_Behavior::getBehaviorFlags(const PSX::PxObstacle& obstacle)
{
	// Obstacle이 움직이는 발판이다? 
	// 여기서 ride/slide 세팅
...
HRESULT CCallBack_EffectHitBox_Behavior::Initialize(CCharacter_Controller* pController, CRigidBody_Dynamic* pPartDynamicObject)
{
...
HRESULT CCallBack_EffectHitBox_Behavior::Finalize()
{
...
CCallBack_EffectHitBox_Behavior* CCallBack_EffectHitBox_Behavior::Create()
{
	return new CCallBack_EffectHitBox_Behavior();
}
