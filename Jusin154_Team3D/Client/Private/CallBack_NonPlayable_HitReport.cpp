...
CCallBack_NonPlayable_HitReport::CCallBack_NonPlayable_HitReport()
{
}
...
void CCallBack_NonPlayable_HitReport::BeginFrame()
{
	// 매 프레임 초기화
...
void CCallBack_NonPlayable_HitReport::onShapeHit(const PSX::PxControllerShapeHit& hit)
{
...
void CCallBack_NonPlayable_HitReport::onControllerHit(const PSX::PxControllersHit& hit)
{
	PSX::PxController* pController = hit.controller;
	PSX::PxExtendedVec3		vWorldPos = hit.worldPos;		// 접촉지점
	PSX::PxVec3				vWorldNormal = hit.worldNormal;	// 접촉노말
...
void CCallBack_NonPlayable_HitReport::onObstacleHit(const PSX::PxControllerObstacleHit& hit)
{
	PSX::PxController* pController = hit.controller;
	PSX::PxExtendedVec3		vWorldPos = hit.worldPos;		// 접촉지점
	PSX::PxVec3				vWorldNormal = hit.worldNormal;	// 접촉노말
...
void CCallBack_NonPlayable_HitReport::Set_CurrentSlop()
{
...
HRESULT CCallBack_NonPlayable_HitReport::Initialize(CCharacter_Controller* pController)
{
...
HRESULT CCallBack_NonPlayable_HitReport::Finalize()
{
...
_bool CCallBack_NonPlayable_HitReport::IsOnGround()
{
	return m_bGroundHit;
}

_vector CCallBack_NonPlayable_HitReport::Get_GroundVector()
{
	return XMLoadFloat3(&m_vClimbNormal);
}

CCallBack_NonPlayable_HitReport* CCallBack_NonPlayable_HitReport::Create()
{
	return new CCallBack_NonPlayable_HitReport();
}
