...
HRESULT CRanrok_Impact::Pre_Setting(CGameObject* pObject, void* pArg)
{
	if (FAILED(__super::Pre_Setting(pObject, nullptr)))
	 ...
	 /* 초기 객체 비지블*/
	CEffectParts* pHit_PT0 = Get_PartObject<CEffectParts>("Hit_PT0");
	CEffectParts* pHit_Pulse = Get_PartObject<CEffectParts>("Hit_Pulse");
	CEffectParts* pRock_PT = Get_PartObject<CEffectParts>("Rock_PT");
	CEffectParts* pSplash_Hit = Get_PartObject<CEffectParts>("Splash_Hit");
