...
void CRenderer::Render()
{
	...
	memcpy_s(&m_MotionBlurPreViewMatrix,	sizeof(_float4x4), &m_ScreenViewMatrix,		sizeof(_float4x4));
	memcpy_s(&m_MotionBlurPreProjMatrix,	sizeof(_float4x4), &m_ScreenProjMatrix,		sizeof(_float4x4));
