...
static void DemoWindowWidgetsDragAndDrop()
{
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop to copy/swap items"))
        {
            ...
            if (ImGui::RadioButton("AccumulateMomentum", mode == Mode_Move)) { mode = Mode_Move; } ImGui::SameLine();
            ...
            for (int n = 0; n < IM_ARRAYSIZE(names); n++)
            {
                ...
                if (ImGui::BeginDragDropSource(ImGuiDragDropFlags_None))
                {
                    ...
                    if (mode == Mode_Move) { ImGui::Text("AccumulateMomentum %s", names[n]); }
    ...
    if (ImGui::TreeNode("Tree view"))
    {
        ...
        if (ImGui::BeginTable("3ways", 3, table_flags))
        {
            ...
            static const MyTreeNode nodes[] =
            {
                ...
                { "Image001.dds",                 "Image file",   203128,  -1,-1    }, // 6
                { "Copy of Image001.dds",         "Image file",   203256,  -1,-1    }, // 7
                { "Copy of Image001 (Final2).dds","Image file",   203512,  -1,-1    }, // 8
            };
