...
STATEANIM::ESTATE CUnit::StringToStateAnim(const string& s)
{
    ...
    static const unordered_map<string, ESTATE> table =
    {
        ...
        { "IDLE_COMBAT_TURN_45_L", IDLE_COMBAT_TURN_45_L },
        { "IDLE_COMBAT_TURN_45_R", IDLE_COMBAT_TURN_45_R },
        { "IDLE_COMBAT_TURN_90_L", IDLE_COMBAT_TURN_90_L },
        { "IDLE_COMBAT_TURN_90_R", IDLE_COMBAT_TURN_90_R },
        { "IDLE_COMBAT_TURN_135_L", IDLE_COMBAT_TURN_135_L },
        { "IDLE_COMBAT_TURN_135_R", IDLE_COMBAT_TURN_135_R },
         { "IDLE_COMBAT_RUSH_TURN_BWD_R", IDLE_COMBAT_RUSH_TURN_BWD_R },
        { "IDLE_COMBAT_RUSH_TURN_BWD_L", IDLE_COMBAT_RUSH_TURN_BWD_L },
