...
HRESULT CGraphic_Device::Initialize(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, _Inout_ ID3D11Device** ppDevice, _Inout_ ID3D11DeviceContext** ppContext)
{
	_uint		iFlag = 0;
	...
	if (FAILED(Ready_SwapChain(hWnd, iWinSizeX, iWinSizeY)))
		return E_FAIL;
...
HRESULT CGraphic_Device::Ready_SwapChain(HWND hWnd, _uint iWinCX, _uint iWinCY)
{
...
CGraphic_Device* CGraphic_Device::Create(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, _Out_ ID3D11Device** ppDevice, _Out_ ID3D11DeviceContext** ppDeviceContextOut)
{
	CGraphic_Device* pInstance = new CGraphic_Device();

	if (FAILED(pInstance->Initialize(hWnd, iWinSizeX, iWinSizeY, ppDevice, ppDeviceContextOut)))
	{
