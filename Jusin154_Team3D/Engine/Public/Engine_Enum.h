...
enum class RENDER {PRIORITY, SHADOW, NONBLEND, DECAL, BLUR, NONLIGHT, EFFECT ,BLEND, BLOOM, UI, OCCLUSION, PRESHADOW, UI_OVERLAY, END };
...
enum class MODEL { ANIM, NONANIM, PBR_NONANIM, PBR_ANIM, ENVIRONMENT, ANIM_LOCAL,NONANIM_LOCAL};
