...
static constexpr pair<string_view, TIMESOCKET_FUNC> g_SocketFuncTypeTable[ENUM_CLASS(TIMESOCKET_FUNC::END) + 1] =
{
	...
	// EFFECT
	{"RANROK_SHOUT",			TIMESOCKET_FUNC::RANROK_SHOUT},
	{"INTRO_FIRE",				TIMESOCKET_FUNC::INTRO_FIRE},
	{"INTRO_LIGHTNING",			TIMESOCKET_FUNC::INTRO_LIGHTNING},
	{"INTRO_SMOKE",				TIMESOCKET_FUNC::INTRO_SMOKE},
	// SOUND
