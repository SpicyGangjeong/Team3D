...
public:
	...
	void	FitY(_fmatrix WorldMatrix, _float fY, _float3 vPickingPos, _uint iRange, _bool isFlat);
	void	Add_NeighborY(VTXNORTEX* pVertices, _uint iX, _uint iZ, _float fY, _uint iRange);
	void	Flat_NeighborY(VTXNORTEX* pVertices, _uint iX, _uint iZ, _float fY, _uint iRange);
	void	Add_Y(VTXNORTEX* pVertices, _uint iIndex, _float fY);
	void	Flat(VTXNORTEX* pVertices, _uint iIndex, _float fY);
