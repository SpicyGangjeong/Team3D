...
class CBombardSide final : public CEffect_Container
{
private:
	CBombardSide(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBombardSide(const CBombardSide& rhs);
	virtual ~CBombardSide() = default;
...
public:
	static CBombardSide* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
