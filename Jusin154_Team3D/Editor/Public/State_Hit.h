...
class CState_Hit final : public CState_Root
{
public:
    typedef struct tagHit : public CState_Root::STATE_ROOT_DESC {
...
private:
    HRESULT Initialize(STATE_HIT_DESC* pDesc);

public:
    static CState_Hit* Create(STATE_HIT_DESC* pDesc);
