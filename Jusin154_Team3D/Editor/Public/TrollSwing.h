...
class CTrollSwing final : public CEffect_Container
{
private:
	CTrollSwing(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTrollSwing(const CTrollSwing& rhs);
	virtual ~CTrollSwing() = default;
