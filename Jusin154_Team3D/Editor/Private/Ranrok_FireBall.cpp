...
HRESULT CRanrok_FireBall::Initialize(void* pArg)
{
	...
	m_pFireBall = Get_PartObject<CEditEffect>("FireBall");
	m_pFireBall_PT = Get_PartObject<CEditEffect>("FireBall_PT");
	m_pFireBall_Surface = Get_PartObject<CEditEffect>("FireBall_Surface");
...
HRESULT CRanrok_FireBall::Pre_Setting(CGameObject* pObject, void* pArg)
{
	...
	CEditEffect* pBlack_Smoke = Get_PartObject<CEditEffect>("Black_Smoke");
	CEditEffect* pFireBall_Ring = Get_PartObject<CEditEffect>("FireBall_Ring");
