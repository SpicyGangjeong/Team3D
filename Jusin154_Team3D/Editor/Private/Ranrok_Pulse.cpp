...
HRESULT CRanrok_Pulse::Pre_Setting(CGameObject* pObject, void* pArg)
{
	...
	pBottomDecal->Get_Component<CTransform>()->Set_State(STATE::POSITION, vPlayer_FootPos);
	pBottomSplatter->Get_Component<CTransform>()->Set_State(STATE::POSITION, vPlayer_FootPos);
	pBottomSplatter2->Get_Component<CTransform>()->Set_State(STATE::POSITION, vPlayer_FootPos);
	pRock_PT->Get_Component<CTransform>()->Set_State(STATE::POSITION, vPlayer_FootPos);
	pSmoke->Get_Component<CTransform>()->Set_State(STATE::POSITION, vPlayer_FootPos);
