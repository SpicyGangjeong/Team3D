...
#pragma region EFFECT
	...
	if (FAILED(Add_PartObject<CEditEffect>("Goblin_Particle", NEXT_LEVEL, &m_pGoblin_Particle, &PartsDesc)))
	{
		return E_FAIL;
	}
	...
	if (FAILED(Add_PartObject<CEditEffect>("Goblin_Particle2", NEXT_LEVEL, &m_pGoblin_Particle2, &PartsDesc)))
	{
		return E_FAIL;
	}
	...
	if (FAILED(Add_PartObject<CEditEffect>("Goblin_Smoke", NEXT_LEVEL, &m_pSmoke, &PartsDesc)))
	{
		return E_FAIL;
	}
