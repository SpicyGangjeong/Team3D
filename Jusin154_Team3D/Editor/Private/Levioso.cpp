...
HRESULT CLevioso::Initialize(void* pArg)
{
	...
	m_pLeviosoPJ = Get_PartObject<CEditEffect>("Levioso_PJ");
...
HRESULT CLevioso::Pre_Setting(CGameObject* pObject, void* pArg)
{
	...
	CEditEffect* pWandSmoke = Get_PartObject<CEditEffect>("Wand_Smoke");
	CEditEffect* pWandLight = Get_PartObject<CEditEffect>("Wand_Light_P");
	CEditEffect* pSpread_Circle = Get_PartObject<CEditEffect>("Spread_Circle");
...
void CLevioso::OnCollision(CGameObject* pOther, void* pDesc)
{
	...
	CEditEffect* pLevioso_Spline = Get_PartObject<CEditEffect>("Levioso_Spline");
	CEditEffect* pLevioso_Hit0 = Get_PartObject<CEditEffect>("Levioso_Hit0");
