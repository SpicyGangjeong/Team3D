...
#pragma region EFFECT
	...
	if (FAILED(Add_PartObject<CEditEffect>("Troll_Particle", NEXT_LEVEL, &m_pTroll_Particle, &PartsDesc)))
	{
		return E_FAIL;
	}
	...
	if (FAILED(Add_PartObject<CEditEffect>("Troll_Particle2", NEXT_LEVEL, &m_pTroll_Particle2, &PartsDesc)))
	{
		return E_FAIL;
	}
	...
	if (FAILED(Add_PartObject<CEditEffect>("Troll_Right_Smoke", NEXT_LEVEL, &m_pRight_Smoke, &PartsDesc)))
	{
		return E_FAIL;
	}
	...
	if (FAILED(Add_PartObject<CEditEffect>("Troll_Left_Smoke", NEXT_LEVEL, &m_pLeft_Smoke, &PartsDesc)))
	{
		return E_FAIL;
	}
