...
{
	Compute_UI(static_cast<CUIObject*>(m_pOwner)->Get_Learninfo(Index).iSpellID);
	m_vUVScale.y = 0.f;
	m_fTrail = 0.f;
	m_iSpellType = static_cast<CUIObject*>(m_pOwner)->Get_Learninfo(Index).iSpellType;
	m_fSpellLearn = _float(static_cast<CUIObject*>(m_pOwner)->Get_Learninfo(Index).Lines.size());
