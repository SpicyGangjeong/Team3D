...
HRESULT CNomalJapSide::Initialize(void* pArg)
{
	...
	m_pWandParticle = Get_PartObject<CEditEffect>("WandParticle1");
	m_pWandLight_R = Get_PartObject<CEditEffect>("Wand_Light_R");
	m_pWandLight = Get_PartObject<CEditEffect>("Wand_Red_Long");
