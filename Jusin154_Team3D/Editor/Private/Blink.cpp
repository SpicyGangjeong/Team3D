...
HRESULT CBlink::Initialize(void* pArg)
{
	...
	m_pBlink_Swirl = Get_PartObject<CEditEffect>("BlinkSwirl");
	m_pBlink_Circle = Get_PartObject<CEditEffect>("Blink_Circle");
	m_pBlink_Circle2 = Get_PartObject<CEditEffect>("Blink_Circle2");
	m_pBlink_Distortion = Get_PartObject<CEditEffect>("Blink_Distortion");
