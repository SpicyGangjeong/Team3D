...
HRESULT CRevelio::Initialize(void* pArg)
{
	...
	m_pWand_Light = Get_PartObject<CEditEffect>("Wand_Light");
...
HRESULT CRevelio::Pre_Setting(CGameObject* pObject, void* pArg)
{
	...
	CEditEffect* pRevelio_ScreenFX = Get_PartObject<CEditEffect>("Revelio_ScreenFX");
	CEditEffect* pRevelio_ScreenFX_Reverse = Get_PartObject<CEditEffect>("Revelio_ScreenFX_Reverse");
	CEditEffect* pRevelio_Smoke = Get_PartObject<CEditEffect>("Revelio_Smoke");
	CEditEffect* pRevelio_Distortion = Get_PartObject<CEditEffect>("Revelio_Distortion");
	CEditEffect* pBottom_PT = Get_PartObject<CEditEffect>("Bottom_PT");
